    ...
    render() {
        return (
            <div className="InfoPage container-fluid">
                ...
                <p>We have compiled a list of coronavirus-related resources to connect volunteers with projects and those in need.</p>
                <br></br>
                <div class="row">
                ...
                <p>Note: ArchHacks does not affiliate with or endorse any of the above resources.</p>
            </div>
            </div>
        )
    }
