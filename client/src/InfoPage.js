                        ...
                        <div className="Info-Right-Content">
                            ...
                            <div className="Info-Right-Thick">
                                ...
                                <div className="Info-FAQ-Text">
                                    ...
                                    <p className="hide-this Info-Question FAQ-Logistics">What are the event times?</p>
                                    <p className="hide-this Info-Answer FAQ-Logistics">ArchHacks starts at 4pm on February 28th and ends at 2pm on March 1st.</p>
                                    <p className="hide-this Info-Question FAQ-Logistics">What do I need to participate?</p>
                                    <p className="hide-this Info-Answer FAQ-Logistics">The only thing you have to bring is curiosity and the willingness to contribute ideas. A computer is recommended, but not necessary. A change of clothes, toothbrush, sleeping bag and pillow might be advisable as the hack lasts 48 hours, but that’s your call, we won’t judge.</p>
